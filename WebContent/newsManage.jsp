		...
		<div class="col-md-12 column">
			<div class="tabbable" id="tabs-572786">
				<ul class="nav nav-tabs">
				    <li class="active">
						 <a href="#panel-168171" data-toggle="tab">资讯列表</a>
					</li>
					<li>
						 <a href="#panel-172010" data-toggle="tab">发布资讯</a>
					</li>
				</ul>
			...
			<table class="table">
				...
				<c:forEach items="${messageList}" var="message">
					<tr>
						...
						<td>
							<a href="messageInfo.do?messageId=${message.messageId}&messageFlag=message"><button type="button" class="btn btn-info">资讯详情</button></a>
						</td>
					</tr>
					</c:forEach>
				</tbody>
